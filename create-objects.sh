...
oc secrets new-dockercfg docker-registry --docker-server=docker-registry-default.apps.demo.openshift.fr --docker-username=admin --docker-password=$(oc whoami -t) --docker-email=test@test.com
